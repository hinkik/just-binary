...
describe("file", () => {
  describe("binary files", () => {
    it("should detect PNG files from magic bytes", async () => {
      ...
      const result = await toText(await env.exec("file /tmp/test.png"));
    ...
    it("should detect GIF files from magic bytes", async () => {
      ...
      const result = await toText(await env.exec("file /tmp/test.gif"));
    ...
    it("should detect ZIP files from magic bytes", async () => {
      ...
      const result = await toText(await env.exec("file /tmp/test.zip"));
    ...
    it("should detect PDF files from magic bytes", async () => {
      ...
      const result = await toText(await env.exec("file /tmp/test.pdf"));
    ...
    it("should return correct MIME type for binary files with -i", async () => {
      ...
      await env.fs.writeFile("/tmp/test.png", pngMagic);
      const result = await toText(await env.exec("file -i /tmp/test.png"));
    ...
    it("should not corrupt binary data when detecting file type", async () => {
      ...
      const result = await toText(await env.exec("file /binary.png"));
  ...
  describe("text files", () => {
    it("should detect ASCII text", async () => {
      ...
      const result = await toText(await env.exec("file /tmp/test.txt"));
    ...
    it("should detect empty files", async () => {
      ...
      const result = await toText(await env.exec("file /tmp/empty"));
    ...
    it("should detect CRLF line endings", async () => {
      ...
      const result = await toText(await env.exec("file /tmp/crlf.txt"));
    ...
    it("should detect shell scripts by shebang", async () => {
      ...
      const result = await toText(await env.exec("file /tmp/script.sh"));
      expect(result.stdout).toBe(
    ...
    it("should detect Python scripts by shebang", async () => {
      ...
      const result = await toText(await env.exec("file /tmp/script.py"));
      expect(result.stdout).toBe(
  ...
  describe("extension-based detection", () => {
    it("should detect TypeScript files", async () => {
      ...
      const result = await toText(await env.exec("file /tmp/test.ts"));
    ...
    it("should detect JavaScript files", async () => {
      ...
      const result = await toText(await env.exec("file /tmp/test.js"));
    ...
    it("should detect JSON files", async () => {
      ...
      const result = await toText(await env.exec("file /tmp/test.json"));
    ...
    it("should detect Markdown files", async () => {
      ...
      const result = await toText(await env.exec("file /tmp/test.md"));
  ...
  describe("directories", () => {
    it("should detect directories", async () => {
      ...
      const result = await toText(await env.exec("file /tmp/testdir"));
  ...
  describe("options", () => {
    it("should support -b (brief) mode", async () => {
      ...
      const result = await toText(await env.exec("file -b /tmp/test.txt"));
    ...
    it("should support -i (mime) mode", async () => {
      const env = new Bash();
      await env.exec("echo 'hello' > /tmp/test.txt");
      const result = await toText(await env.exec("file -i /tmp/test.txt"));
    ...
    it("should support combined -bi mode", async () => {
      ...
      const result = await toText(await env.exec("file -bi /tmp/mimedir"));
  ...
  describe("multiple files", () => {
    it("should handle multiple files", async () => {
      ...
      const result = await toText(await env.exec("file /tmp/a.txt /tmp/b.txt"));
      expect(result.stdout).toBe(
  ...
  describe("error handling", () => {
    it("should error on missing file", async () => {
      const env = new Bash();
      const result = await toText(await env.exec("file /tmp/nonexistent"));
      expect(result.stdout).toBe(
    ...
    it("should error with no arguments", async () => {
      const env = new Bash();
      const result = await toText(await env.exec("file"));
  ...
  describe("--help", () => {
    it("should display help", async () => {
      const env = new Bash();
      const result = await toText(await env.exec("file --help"));
