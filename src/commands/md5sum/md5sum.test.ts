...
describe("md5sum", () => {
  describe("basic hashing", () => {
    it("should hash a simple string", async () => {
      const env = new Bash();
      const result = await toText(await env.exec("echo -n 'hello' | md5sum"));
    ...
    it("should hash empty input", async () => {
      const env = new Bash();
      const result = await toText(await env.exec("echo -n '' | md5sum"));
    ...
    it("should hash a file", async () => {
      ...
      const result = await toText(await env.exec("md5sum /tmp/test.txt"));
    ...
    it("should hash multiple files", async () => {
      ...
      const result = await toText(
        await env.exec("md5sum /tmp/a.txt /tmp/b.txt"),
      );
  ...
  describe("check mode", () => {
    it("should verify correct checksums", async () => {
      ...
      const result = await toText(await env.exec("md5sum -c /tmp/sums.txt"));
  ...
  describe("error handling", () => {
    it("should error on missing file", async () => {
      const env = new Bash();
      const result = await toText(await env.exec("md5sum /tmp/nonexistent"));
  ...
  describe("--help", () => {
    it("should display help", async () => {
      const env = new Bash();
      const result = await toText(await env.exec("md5sum --help"));
...
describe("sha1sum", () => {
  it("should hash a simple string", async () => {
    const env = new Bash();
    const result = await toText(await env.exec("echo -n 'hello' | sha1sum"));
  ...
  it("should hash empty input", async () => {
    const env = new Bash();
    const result = await toText(await env.exec("echo -n '' | sha1sum"));
...
describe("binary files", () => {
  it("should hash binary file with invalid UTF-8 bytes correctly", async () => {
    ...
    const result = await toText(await env.exec("md5sum /binary.dat"));
  ...
  it("should hash binary file with null bytes correctly", async () => {
    ...
    const result = await toText(await env.exec("md5sum /nulls.dat"));
    // MD5 of 4 null bytes
    expect(result.stdout).toBe(
  ...
  it("should hash binary file with sha256sum correctly", async () => {
    ...
    const result = await toText(await env.exec("sha256sum /binary.dat"));
...
describe("sha256sum", () => {
  it("should hash a simple string", async () => {
    const env = new Bash();
    const result = await toText(await env.exec("echo -n 'hello' | sha256sum"));
  ...
  it("should hash empty input", async () => {
    const env = new Bash();
    const result = await toText(await env.exec("echo -n '' | sha256sum"));
  ...
  describe("--help", () => {
    it("should display help", async () => {
      const env = new Bash();
      const result = await toText(await env.exec("sha256sum --help"));
