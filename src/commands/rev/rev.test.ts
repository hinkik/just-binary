...
describe("rev", () => {
  it("reverses a simple string", async () => {
    const bash = new Bash();
    const result = toText(await bash.exec("echo 'hello' | rev"));
  ...
  it("reverses multiple lines", async () => {
    const bash = new Bash();
    const result = toText(await bash.exec("printf 'abc\\ndef\\nghi' | rev"));
    expect(result.exitCode).toBe(0);
  ...
  it("handles empty input", async () => {
    const bash = new Bash();
    const result = toText(await bash.exec("printf '' | rev"));
    expect(result.exitCode).toBe(0);
  ...
  it("handles single character", async () => {
    const bash = new Bash();
    const result = toText(await bash.exec("echo 'a' | rev"));
    expect(result.exitCode).toBe(0);
  ...
  it("reads from file", async () => {
    ...
    const result = toText(await bash.exec("rev /test.txt"));
    expect(result.exitCode).toBe(0);
    expect(result.stdout).toBe("olleh\ndlrow\n");
  });
  ...
  it("reads from multiple files", async () => {
    ...
    const result = toText(await bash.exec("rev /a.txt /b.txt"));
    expect(result.exitCode).toBe(0);
    expect(result.stdout).toBe("cba\nfed\n");
  });
  ...
  it("handles file not found", async () => {
    const bash = new Bash();
    const result = toText(await bash.exec("rev /nonexistent.txt"));
  ...
  it("handles Unicode characters", async () => {
    const bash = new Bash();
    const result = toText(await bash.exec("echo '日本語' | rev"));
    expect(result.exitCode).toBe(0);
  ...
  it("handles emoji", async () => {
    const bash = new Bash();
    const result = toText(await bash.exec("echo '👋🌍' | rev"));
    expect(result.exitCode).toBe(0);
    expect(result.stdout).toBe("🌍👋\n");
  });
  ...
  it("shows help with --help", async () => {
    const bash = new Bash();
    const result = toText(await bash.exec("rev --help"));
    expect(result.exitCode).toBe(0);
  ...
  it("preserves spaces", async () => {
    const bash = new Bash();
    const result = toText(await bash.exec("echo 'a b c' | rev"));
    expect(result.exitCode).toBe(0);
  ...
  it("handles tabs", async () => {
    const bash = new Bash();
    const result = toText(await bash.exec("printf 'a\\tb\\tc' | rev"));
    expect(result.exitCode).toBe(0);
    expect(result.stdout).toBe("c\tb\ta");
  });
  ...
  it("errors on unknown flag", async () => {
    const bash = new Bash();
    const result = toText(await bash.exec("echo 'test' | rev -x"));
    expect(result.exitCode).toBe(1);
  ...
  it("errors on unknown long flag", async () => {
    const bash = new Bash();
    const result = toText(await bash.exec("echo 'test' | rev --unknown"));
    expect(result.exitCode).toBe(1);
  ...
  it("handles -- to end options", async () => {
    ...
    const result = toText(await bash.exec("rev -- /-file.txt"));
    expect(result.exitCode).toBe(0);
