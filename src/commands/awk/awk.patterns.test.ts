...
describe("awk patterns", () => {
  describe("regex patterns", () => {
    it("should match literal regex", async () => {
      ...
      const result = await toText(await env.exec(`awk '/ana/' /data.txt`));
    ...
    it("should match beginning of line with ^", async () => {
      ...
      const result = await toText(await env.exec(`awk '/^a/' /data.txt`));
    ...
    it("should match end of line with $", async () => {
      ...
      const result = await toText(await env.exec(`awk '/llo$/' /data.txt`));
    ...
    it("should match character class", async () => {
      ...
      const result = await toText(await env.exec(`awk '/[cd]/' /data.txt`));
    ...
    it("should negate character class with [^]", async () => {
      ...
      const result = await toText(await env.exec(`awk '/[^a-z]/' /data.txt`));
    ...
    it("should match with alternation", async () => {
      ...
      const result = await toText(await env.exec(`awk '/red|blue/' /data.txt`));
    ...
    it("should match with quantifiers", async () => {
      ...
      const result = await toText(await env.exec(`awk '/a{2,3}/' /data.txt`));
  ...
  describe("expression patterns", () => {
    it("should match with equality", async () => {
      ...
      const result = await toText(await env.exec(`awk '$1 == 2' /data.txt`));
    ...
    it("should match with greater than", async () => {
      ...
      const result = await toText(await env.exec(`awk '$1 > 25' /data.txt`));
    ...
    it("should match string comparison", async () => {
      ...
      const result = await toText(
        await env.exec(`awk '$1 == "bob"' /data.txt`),
      );
    ...
    it("should match lexicographic comparison", async () => {
      ...
      const result = await toText(await env.exec(`awk '$1 < "c"' /data.txt`));
      expect(result.stdout).toBe("apple\nbanana\n");
      expect(result.exitCode).toBe(0);
    });
  });
  ...
  describe("combined patterns", () => {
    ...
    it("should combine regex and expression", async () => {
      ...
      const result = await toText(
        await env.exec(`awk '/^a/ && $2 > 5' /data.txt`),
      );
  ...
  describe("NR patterns", () => {
    it("should match first line", async () => {
      ...
      const result = await toText(await env.exec(`awk 'NR == 1' /data.txt`));
    ...
    it("should match every Nth line", async () => {
      ...
      const result = await toText(
        await env.exec(`awk 'NR % 2 == 1' /data.txt`),
      );
  ...
  describe("field regex match patterns", () => {
    it("should match field with regex using ~", async () => {
      ...
      const result = await toText(await env.exec(`awk '$1 ~ /^a/' /data.txt`));
    ...
    it("should match second field", async () => {
      ...
      const result = await toText(await env.exec(`awk '$2 ~ /^a/' /data.txt`));
  ...
  describe("pattern-only rules", () => {
    it("should print matching line with pattern only", async () => {
      ...
      const result = await toText(await env.exec(`awk '/yes/' /data.txt`));
