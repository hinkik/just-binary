...
describe("date", () => {
  describe("format specifiers", () => {
    it("should format year with %Y", async () => {
      const env = new Bash();
      const result = toText(await env.exec("date +%Y"));
    ...
    it("should format month with %m", async () => {
      const env = new Bash();
      const result = toText(await env.exec("date +%m"));
    ...
    it("should format day with %d", async () => {
      const env = new Bash();
      const result = toText(await env.exec("date +%d"));
    ...
    it("should format ISO date with %F", async () => {
      const env = new Bash();
      const result = toText(await env.exec("date +%F"));
    ...
    it("should format time with %T", async () => {
      const env = new Bash();
      const result = toText(await env.exec("date +%T"));
    ...
    it("should format hours with %H", async () => {
      const env = new Bash();
      const result = toText(await env.exec("date +%H"));
    ...
    it("should format 12-hour with %I", async () => {
      const env = new Bash();
      const result = toText(await env.exec("date +%I"));
      expect(result.stdout).toMatch(/^(0[1-9]|1[0-2])\n$/);
      expect(result.exitCode).toBe(0);
    });
    ...
    it("should format seconds with %S", async () => {
      const env = new Bash();
      const result = toText(await env.exec("date +%S"));
      expect(result.stdout).toMatch(/^[0-5]\d\n$/);
      expect(result.exitCode).toBe(0);
    });
    ...
    it("should format weekday name with %a", async () => {
      const env = new Bash();
      const result = toText(await env.exec("date +%a"));
    ...
    it("should format month name with %b", async () => {
      const env = new Bash();
      const result = toText(await env.exec("date +%b"));
    ...
    it("should format AM/PM with %p", async () => {
      const env = new Bash();
      const result = toText(await env.exec("date +%p"));
    ...
    it("should handle literal percent with %%", async () => {
      const env = new Bash();
      const result = toText(await env.exec("date +%%"));
    ...
    it("should handle combined format string", async () => {
      const env = new Bash();
      const result = toText(await env.exec("date '+%Y-%m-%d %H:%M:%S'"));
    ...
    it("should handle newline with %n", async () => {
      const env = new Bash();
      const result = toText(await env.exec("date '+%Y%n%m'"));
      expect(result.stdout).toMatch(/^\d{4}\n\d{2}\n$/);
      expect(result.exitCode).toBe(0);
    });
    ...
    it("should handle tab with %t", async () => {
      const env = new Bash();
      const result = toText(await env.exec("date '+%Y%t%m'"));
  ...
  describe("options", () => {
    ...
    it("should output RFC format with -R", async () => {
      const env = new Bash();
      const result = toText(await env.exec("date -R"));
      expect(result.stdout).toMatch(
    ...
    it("should output UTC with -u", async () => {
      const env = new Bash();
      const result = toText(await env.exec("date -u +%Z"));
  ...
  describe("relative dates", () => {
    it("should parse 'now'", async () => {
      const env = new Bash();
      const result = toText(await env.exec("date -d now +%s"));
      const timestamp = Number.parseInt(result.stdout.trim(), 10);
    ...
    it("should parse 'today'", async () => {
      const env = new Bash();
      const result = toText(await env.exec("date -d today +%F"));
    ...
    it("should parse 'yesterday'", async () => {
      const env = new Bash();
      const result = toText(await env.exec("date -d yesterday +%F"));
    ...
    it("should parse 'tomorrow'", async () => {
      const env = new Bash();
      const result = toText(await env.exec("date -d tomorrow +%F"));
  ...
  describe("error handling", () => {
    ...
    it("should error on unknown option", async () => {
      const env = new Bash();
      const result = toText(await env.exec("date --unknown"));
    ...
    it("should error on unknown short option", async () => {
      const env = new Bash();
      const result = toText(await env.exec("date -z"));
  ...
  describe("help", () => {
    it("should show help with --help", async () => {
      const env = new Bash();
      const result = toText(await env.exec("date --help"));
