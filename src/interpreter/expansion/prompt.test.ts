...
describe("prompt expansion", () => {
  describe("basic escapes", () => {
    ...
    it("should expand \\r to carriage return", async () => {
      const env = new Bash();
      const result = await toText(
        await env.exec("x=$'a\\rb'; echo \"${x@P}\""),
      );
    ...
    it("should expand \\\\ to backslash", async () => {
      const env = new Bash();
      const result = await toText(await env.exec('x="a\\\\b"; echo "${x@P}"'));
    ...
    it("should expand \\a to bell character", async () => {
      const env = new Bash();
      const result = await toText(await env.exec('x="\\a"; echo "${x@P}"'));
    ...
    it("should expand \\e to escape character", async () => {
      const env = new Bash();
      const result = await toText(await env.exec('x="\\e[1m"; echo "${x@P}"'));
    ...
    it("should expand \\$ to $ for regular user", async () => {
      const env = new Bash();
      const result = await toText(
        await env.exec('x="prompt\\$ "; echo "${x@P}"'),
      );
  ...
  describe("user and host escapes", () => {
    it("should expand \\u to username", async () => {
      ...
      const result = await toText(await env.exec('x="\\u"; echo "${x@P}"'));
    ...
    it("should expand \\h to short hostname", async () => {
      ...
      const result = await toText(await env.exec('x="\\h"; echo "${x@P}"'));
  ...
  describe("directory escapes", () => {
    it("should expand \\w to current working directory", async () => {
      ...
      const result = await toText(await env.exec('x="\\w"; echo "${x@P}"'));
  ...
  describe("shell info escapes", () => {
    it("should expand \\s to shell name", async () => {
      const env = new Bash();
      const result = await toText(await env.exec('x="\\s"; echo "${x@P}"'));
    ...
    it("should expand \\v to version major.minor", async () => {
      const env = new Bash();
      const result = await toText(await env.exec('x="\\v"; echo "${x@P}"'));
    ...
    it("should expand \\j to number of jobs", async () => {
      const env = new Bash();
      const result = await toText(await env.exec('x="\\j"; echo "${x@P}"'));
    ...
    it("should expand \\l to terminal name", async () => {
      const env = new Bash();
      const result = await toText(await env.exec('x="\\l"; echo "${x@P}"'));
  ...
  describe("time escapes", () => {
    it("should expand \\t to 24-hour time HH:MM:SS", async () => {
      const env = new Bash();
      const result = await toText(await env.exec('x="\\t"; echo "${x@P}"'));
    ...
    it("should expand \\T to 12-hour time HH:MM:SS", async () => {
      const env = new Bash();
      const result = await toText(await env.exec('x="\\T"; echo "${x@P}"'));
    ...
    it("should expand \\d to date", async () => {
      const env = new Bash();
      const result = await toText(await env.exec('x="\\d"; echo "${x@P}"'));
      // Format: Day Mon DD
  ...
  describe("strftime with \\D{format}", () => {
    it("should expand \\D{%Y} to year", async () => {
      const env = new Bash();
      const result = await toText(await env.exec('x="\\D{%Y}"; echo "${x@P}"'));
    ...
    it("should expand \\D{%m} to month", async () => {
      const env = new Bash();
      const result = await toText(await env.exec('x="\\D{%m}"; echo "${x@P}"'));
    ...
    it("should expand \\D{%d} to day", async () => {
      const env = new Bash();
      const result = await toText(await env.exec('x="\\D{%d}"; echo "${x@P}"'));
      expect(result.stdout).toMatch(/^\d{2}\n$/);
      expect(result.exitCode).toBe(0);
    });
    ...
    it("should expand \\D{%H:%M:%S} to time", async () => {
      const env = new Bash();
      const result = await toText(
        await env.exec('x="\\D{%H:%M:%S}"; echo "${x@P}"'),
      );
      expect(result.stdout).toMatch(/^\d{2}:\d{2}:\d{2}\n$/);
      expect(result.exitCode).toBe(0);
    });
    ...
    it("should expand \\D{%a %b} to abbreviated day and month", async () => {
      const env = new Bash();
      const result = await toText(
        await env.exec('x="\\D{%a %b}"; echo "${x@P}"'),
      );
      expect(result.stdout).toMatch(
    ...
    it("should handle \\D without braces as literal", async () => {
      const env = new Bash();
      const result = await toText(await env.exec('x="\\Dfoo"; echo "${x@P}"'));
  ...
  describe("octal escapes", () => {
    it("should expand \\NNN octal codes", async () => {
      const env = new Bash();
      const result = await toText(
        await env.exec('x="\\101\\102\\103"; echo "${x@P}"'),
      );
    ...
    it("should handle wraparound for large octal values", async () => {
      ...
      const result = await toText(await env.exec('x="\\555"; echo "${x@P}"'));
  ...
  describe("command number escapes", () => {
    it("should expand \\# to command number", async () => {
      ...
      const result = await toText(await env.exec('x="cmd \\#"; echo "${x@P}"'));
    ...
    it("should expand \\! to history number", async () => {
      ...
      const result = await toText(
        await env.exec('x="hist \\!"; echo "${x@P}"'),
      );
  ...
  describe("non-printing delimiters", () => {
    it("should remove \\[ and \\] delimiters", async () => {
      const env = new Bash();
      const result = await toText(
        await env.exec('x="\\[\\e[1m\\]bold\\[\\e[0m\\]"; echo "${x@P}"'),
      );
  ...
  describe("combined prompts", () => {
    it("should expand complex PS1-like prompt", async () => {
      ...
      const result = await toText(
        await env.exec('x="\\u@\\h:\\w\\$ "; echo "${x@P}"'),
      );
    ...
    it("should handle unknown escapes as literal", async () => {
      const env = new Bash();
      const result = await toText(
        await env.exec('x="\\z\\q\\x"; echo "${x@P}"'),
      );
